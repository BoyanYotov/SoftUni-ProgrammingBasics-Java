...
public class SleepyTomCat_02 {
    public static void main(String[] args) {
        ...
        if (playTime <= 30000){
            System.out.printf("Tom sleeps well%n%d hours and %.0f minutes less for play", differenceHours,differenceMinutes);
        } else {
            System.out.printf("Tom will run away%n%d hours and %.0f minutes more for play", differenceHours,differenceMinutes);
        }
